...
function addRegionsToMap(key){var isoCode=key.split("_")[0].toUpperCase();console.log(isoCode);$.each(jsonCountries,function(index,currentCountry){if(currentCountry.Country==isoCode)
