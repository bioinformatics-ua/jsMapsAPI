...
function addMarkersToMainMap(jsonMarkers){console.log(jsonMarkers);$.each(jsonMarkers,function(index,currentMarker){maps.addMarker(index,{latLng:[currentMarker.Latitude,currentMarker.Longitude],name:currentMarker.desc,style:{fill:'green',r:mapRange(currentMarker.Count,minCount,maxCount,minRadius,maxRadius)}});});}
