...
this.createSlider();};function addMarkersTooltip(){var onMarkerFunction=function(e,label,index){var finalTooltip=buildMarkerTooltip(jsonMarkers,index);label.html(finalTooltip);};availableMaps=maps.maps;for(var key in availableMaps){console.log(key);maps.maps[key].params.onMarkerTipShow=onMarkerFunction;console.log(maps.maps[key].params.onMarkerTipShow);}}
...
found=true;};if(found){addMarkersToThisMap(key);addMarkersTooltip();}
else
