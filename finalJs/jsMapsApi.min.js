...
function switchMap(newMap){$('#'+mDiv).empty();$('.jvectormap-tip').remove();var palette=['#66C2A5','#FC8D62','#8DA0CB','#E78AC3','#A6D854'];function generateColors(){var colors={},key;colors[maps.region]
