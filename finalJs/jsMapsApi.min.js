...
countryName.html(countryName.html());},series:{markers:[{scale:[minColorMap,maxColorMap],values:[minCount,maxCount],legend:{vertical:true}}],regions:[{scale:[minColorMap,maxColorMap],attribute:'fill',values:[]}]}});console.log('Adding markers tooltip to '+currentMap);var onMarkerFunction=maps.maps[mapType].params.onMarkerTipShow;maps.maps[currentMap].params.onMarkerTipShow=jvmMapMain.params.onMarkerTipShow;maps.maps[currentMap].params.series=jvmMapMain.params.series;maps.maps[currentMap].params.onRegionTipShow=jvmMapMain.params.onRegionTipShow;console.log(maps.maps[currentMap].params);console.log(jvmMapMain.params);}
