...
regionName.html(regionName.html());},series:{markers:[{scale:[minColorMap,maxColorMap],values:[minCount,maxCount],legend:{vertical:true}}],regions:[{scale:[minColorMap,maxColorMap],attribute:'fill',values:regionColors}]}});if(thereAreMarkers){console.log('there are markers');addMarkersToMap();}
if(jsonCountries){}}
