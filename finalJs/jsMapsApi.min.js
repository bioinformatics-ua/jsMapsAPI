...
if(inputJSON.markers){thereAreMarkers=true;jsonMarkers=readMarkersFromJSON(inputJSON.markers);filteredMarkers=jsonMarkers;numMarkers=jsonMarkers.length;}
...
countryName.html(countryName.html());},series:{markers:[{scale:[minColorMap,maxColorMap],values:[minCount,maxCount],legend:{vertical:true}}],regions:[{scale:[minColorMap,maxColorMap],attribute:'fill',values:auxColors}]}});if(inputJSON.markers){filteredMarkers=jsonMarkers;addMarkersToMap();}
